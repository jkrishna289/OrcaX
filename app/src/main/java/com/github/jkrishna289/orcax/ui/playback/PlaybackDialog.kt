            ...
            LazyColumn(
                ...
                item {
                    ListItem(
                        ...
                        onClick = { onSelectChoice(TrackIndex.DISABLED) },
                        leadingContent = { SelectedLeadingContent(currentChoice == TrackIndex.DISABLED) },
                        headlineContent = { Text(text = stringResource(R.string.none)) },
                        supportingContent = {},
                    )
                }
                item {
                    ListItem(
                        ...
                        onClick = { onSelectChoice(TrackIndex.ONLY_FORCED) },
                        leadingContent = { SelectedLeadingContent(currentChoice == TrackIndex.ONLY_FORCED) },
                        headlineContent = { Text(text = stringResource(R.string.only_forced_subtitles)) },
                        supportingContent = {},
                    )
                }
                itemsIndexed(choices) { index, choice ->
                    ...
                    ListItem(
                        ...
                        leadingContent = { SelectedLeadingContent(choice.index == currentChoice) },
                        headlineContent = { Text(text = choice.streamTitle ?: choice.displayTitle) },
                        supportingContent = { if (choice.streamTitle != null) Text(choice.displayTitle) },
                ...
                item {
                    ...
                    ListItem(
                        ...
                        leadingContent = {},
                        headlineContent = { Text(text = stringResource(R.string.search_and_download)) },
                        supportingContent = {},
                    )
                }
            }
