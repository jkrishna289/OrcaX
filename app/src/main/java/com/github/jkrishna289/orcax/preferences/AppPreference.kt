    ...
    companion object {
        val SkipForward =
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value != null) {
                        OrcaApplication.instance.resources.getQuantityString(
                            R.plurals.seconds,
                            value.toInt(),
                            value.toInt(),
                        )
            ...
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value != null) {
                        ...
                        if (v == -1) {
                            OrcaApplication.instance.getString(R.string.no_limit)
                        } else {
                            OrcaApplication.instance.resources.getQuantityString(
                                R.plurals.days,
                                v,
        ...
        val SkipBackOnResume =
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value == 0L) {
                        OrcaApplication.instance.getString(R.string.disabled)
                    } else {
                        "${value}s"
                    }
                },
            ...
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value == null) {
                        ...
                        OrcaApplication.instance.getString(R.string.immediate)
                    } else {
                        OrcaApplication.instance.resources.getQuantityString(
                            R.plurals.seconds,
                            value.toInt(),
        ...
        val SendCrashReports =
            AppSwitchPreference<AppPreferences>(
                ...
                getter = {
                    PreferenceManager
                        .getDefaultSharedPreferences(OrcaApplication.instance)
            ...
            AppSliderPreference<AppPreferences>(
                ...
                summarizer = { value ->
                    if (value != null) {
                        ...
                        OrcaApplication.instance.resources.getString(
                            R.string.decimal_seconds,
                            seconds,
                        )
                    } else {
